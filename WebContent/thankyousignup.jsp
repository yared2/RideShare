...
<div >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item" style=" padding-left: 4em; padding-right: 2em;">
                    <span style="color:yellow; padding-left: 2em; padding-right: 1em; font-size:1.5em">RideShare  makes everyone smile.</span>
                </li>
            </ul>
  ...
  <div id="thankyou">
    	...
    	<h4 style="text-align:center">For Signing up with RideShare</h4>
    	<p>RideShare connects people looking for a ride with affordable fare and enjoy life. We are proud of you for choosing to be a member of ride share.  </p>
    	<br>
    	<p>Have a wonderful and enjoyable rides!</p>
